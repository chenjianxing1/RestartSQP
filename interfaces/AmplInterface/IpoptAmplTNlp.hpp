...
public:
   ...
   /** This is the RestartSqp version for getting the starting point.  We will ignore the one for Ipopt. */
...
private:
   ...
   /** @name arrays that store the values of the suffixes.  ASL does not make a copy
