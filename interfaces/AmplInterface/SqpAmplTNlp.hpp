...
public:
  ...
  {
    return ipopt_ampl_tnlp_->get_starting_point(num_variables, init_primal_variables,
                                         primal_variables, init_bound_multipliers,
                                         bound_multipliers, num_constraints,
  ...
  {
    return ipopt_ampl_tnlp_->finalize_solution(status, num_variables, primal_solution,
                                               bound_multipliers, bound_activity_status,
  ...
  bool get_initial_working_sets(int num_variables,
                                ...
                                int num_constraints,
                                ActivityStatus* constraints_working_set) override
  {
    return ipopt_ampl_tnlp_->get_initial_working_sets(num_variables, bounds_working_set,
                                                     num_constraints, constraints_working_set);
  }
...
private:
  ...
  /** Pointer to the object that can get the SQP specific information from the AMPL interface. */
