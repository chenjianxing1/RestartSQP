...
#define PENALTY_UPDATE_OUTPUT                                                  \
  "%6i %18e %18e %18e \n", iter, rho_trial, infea_measure_model,               \
      infea_measure_infty
// WARNING MESSAGES
#define INVALID_WORKING_SET_MSG                                                \
  "Warning! The working set index in QP is not well defined!"
...
#define SMALL_TRUST_REGION_MSG                                                 \
  "The trust region is smaller than the user-defined minimum value\n"
#endif
