...
namespace SQPhotstart {
    ...
    public:
        ...
        /**
         * @brief This function copies the information from
        ...
        virtual bool
        copy_QP_info(
                     shared_ptr<const QPhandler> rhs,// the QPhandler  object that are going
                     // to be copied from
                     QPType qptype) { return false; }; // is the object rhs an LP?
        
        /**
         * @brief This function updates the bounds on x if
