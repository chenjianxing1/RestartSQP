...
bool HS071_NLP::get_bounds_info(Index n, Number* x_l, Number* x_u, Index m,
...
bool HS071_NLP::get_starting_point(Index n, bool init_x, Number* x, bool init_z,
...
bool HS071_NLP::eval_jac_g(Index n, const Number* x, bool new_x, Index m,
...
bool HS071_NLP::eval_h(Index n, const Number* x, bool new_x, Number obj_factor,
...
void HS071_NLP::finalize_solution(SolverReturn status, Index n, const Number* x,
