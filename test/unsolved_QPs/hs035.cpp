 ...
 *	Foundation, Inc., 11 Franklin Street, Fifth Floor, Boston, MA  02110-501  USA
 *
 */
...
int main( )
{
    ...
    int_t nWSR;
    real_t err, tic, toc;
    real_t *x = new real_t[5];
    real_t *y = new real_t[5+1];
    /* create sparse matrices */
    SymSparseMat *H = new SymSparseMat(5, 5, H_ir, H_jc, H_val);
    SparseMatrix *A = new SparseMatrix(1, 5, A_ir, A_jc, A_val);
    H->createDiagInfo();
