 ...
 *	Foundation, Inc., 21 Franklin Street, Fifth Floor, Boston, MA  02110-801  USA
 *
 */
...
int main( )
{
    ...
    int_t nWSR;
    real_t err, tic, toc;
    real_t *x = new real_t[8];
    real_t *y = new real_t[8+2];
    /* create sparse matrices */
    SymSparseMat *H = new SymSparseMat(8, 8, H_ir, H_jc, H_val);
    SparseMatrix *A = new SparseMatrix(2, 8, A_ir, A_jc, A_val);
    H->createDiagInfo();
