 ...
 * in object stats
 */
    bool qpOASESInterface::optimizeQP(shared_ptr<Matrix> H, shared_ptr<Vector> g, shared_ptr<MatrixWithIdentity> A,
 ...
 */
    bool qpOASESInterface::qpOASESMatrixAdapter(shared_ptr<MatrixWithIdentity> M_in_triplet,
