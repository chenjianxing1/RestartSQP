...
namespace SQPhotstart {
    ...
    public:
         ...
         * objects in qpOASES
         */
        virtual bool copy_QP_info(shared_ptr<QPsolver> rhs,// the QPsolver object that are going to be copied from
