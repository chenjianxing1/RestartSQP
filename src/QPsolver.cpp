...
namespace SQPhotstart {
     ...
     */
    bool QPsolver::GetOptimalSolution(double* p_k) {
     ...
     */
    bool QPsolver::GetMultipliers(double* y_k) {
     ...
     */
    bool QPsolver::init(Index_info nlp_info, QPType qptype) {
     ...
     */
    bool QPsolver::setup_bounds(const SQPhotstart::Number &delta, shared_ptr<SQPhotstart::Vector> x_k,
     ...
     */
    bool QPsolver::setup_g(shared_ptr<Vector> &grad, const Number &rho) {
     ...
     */
    bool QPsolver::update_bounds(const SQPhotstart::Number delta) {
    ...
    bool QPsolver::update_penalty(const SQPhotstart::Number rho) {
     ...
     */
    bool QPsolver::update_grad(shared_ptr<Vector> grad) {
        g_->assign(1, grad->Dim(), grad->vector());
        return true;
    }
     ...
     */
    bool QPsolver::setup_H(shared_ptr<Matrix> hessian) {
     ...
     */
    bool QPsolver::setup_A(shared_ptr<Matrix> jacobian) {
     ...
     */
    bool QPsolver::solveQP(shared_ptr<SQPhotstart::Stats> &stats, shared_ptr<Options> options) {
     ...
     * 		it specifies which type of QP is going to be solved. It can be either LP, or QP, or SOC
     */
    bool QPsolver::allocate(SQPhotstart::Index_info nlp_info, SQPhotstart::QPType qptype) {
        int A_colNum;
        int A_rowNum;
    ...
    bool QPsolver::update_H(shared_ptr<Matrix> Hessian) {
        return false;
    }

    bool QPsolver::update_A(shared_ptr<Matrix> Jacobian) {
        return false;
    }
